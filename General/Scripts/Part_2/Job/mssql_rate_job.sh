...
JOB_PATH="/home/oliwier/Dev/uni/bank-db/General/Scripts/Part_2/Job/run_update_mssql.sh"

# Ten tag identyfikuje nasz job w cronie:
JOB_ID="#JOB_ID_BANK_RATES_V2"

# Działanie: Usuwa starą wersję joba (jeśli istnieje) i dodaje nową.
(crontab -l 2>/dev/null | grep -v "$JOB_ID"; echo "26 11 * * * $JOB_PATH $JOB_ID") | crontab -
...
chmod +x /home/oliwier/Dev/uni/bank-db/General/Scripts/Part_2/Job/run_update_mssql.sh